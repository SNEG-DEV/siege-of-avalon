...
//          if (NPCList.count=5) and (CheckBox[0]=false) and (CheckBox[1]=false) and (CheckBox[2]=false) and (CheckBox[3]=false) and (CheckBox[4]=false) then begin
        ...
        begin
          ...
          if assigned( Character ) then
            WrapperBltFast( lpDDSBack, 40, 174, DXBack, rect( 40, 174, 590, 245 ), DDBLTFAST_WAIT );
          ShowChars;
          lpDDSFront.Flip( nil, DDFLIP_WAIT );
          WrapperBltFast( lpDDSBack, 0, 0, lpDDSFront, Rect( 0, 0, 800, 600 ), DDBLTFAST_WAIT );
          MouseCursor.PlotDirty := false;
...
{$ENDIF}
  try
    ...
    WrapperBltFast( lpDDSBack, 42, 388, DXBack, Rect( 42, 388, 590, 460 ), DDBLTFAST_WAIT );
    if PtinRect( rect( 588, 407, 588 + 77, 412 + 54 ), point( X, Y ) ) then
    begin //over back button
...
//clear checkboxes
  WrapperBltFast( lpDDSBack, 40, vOffset + VAdj1, DXBack, Rect( 40, vOffset + VAdj1, 550, vOffset + VAdj1 + 24 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
  ...
  begin
    ...
    WrapperBltFast( lpDDSBack, CharX + 45, vOffset - 200 + VAdj1, DXBack, Rect( CharX + 45, vOffset - 200 + VAdj1, CharX + 45 + 15, vOffset - 200 + VAdj1 + 15 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if CheckBox[ 0 ] then
      WrapperBltFast( lpDDSBack, CharX + 45, vOffset - 200 + VAdj1, DXBox2, Rect( 0, 0, 15, 15 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT )
    else
      WrapperBltFast( lpDDSBack, CharX + 45, vOffset - 200 + VAdj1, DXBox, Rect( 0, 0, 15, 15 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
  end; //endif assigned
  ...
  begin
    ...
    begin
      ...
      if CheckBox[ 1 ] then
        WrapperBltFast( lpDDSBack, CharX + 45, vOffset + VAdj1, DXBox2, Rect( 0, 0, 15, 15 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT )
      else
        WrapperBltFast( lpDDSBack, CharX + 45, vOffset + VAdj1, DXBox, Rect( 0, 0, 15, 15 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    end
    ...
    begin
      ...
      begin
        WrapperBltFast( lpDDSBack, Region.Left, Region.Top, DXBack,
...
begin
  ...
  WrapperBltFast( lpDDSBack, X,Y,DXSurface,Rect(0,0,148,130),DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT);
...
begin
  WrapperBltFast( lpDDSBack, Region.Left, Region.Top, Image,
  ...
  begin
    if AI.MeleeRanged then
      WrapperBltFast( lpDDSBack, CheckBox[ 0 ].Left, CheckBox[ 0 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.MeleeAggressive then
      WrapperBltFast( lpDDSBack, CheckBox[ 1 ].Left, CheckBox[ 1 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.MeleeDefensive then
      WrapperBltFast( lpDDSBack, CheckBox[ 2 ].Left, CheckBox[ 2 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.MagicAggressive then
      WrapperBltFast( lpDDSBack, CheckBox[ 3 ].Left, CheckBox[ 3 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.MagicDefensive then
      WrapperBltFast( lpDDSBack, CheckBox[ 4 ].Left, CheckBox[ 4 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.HoldAggressive then
      WrapperBltFast( lpDDSBack, CheckBox[ 5 ].Left, CheckBox[ 5 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.HoldDefensive then
      WrapperBltFast( lpDDSBack, CheckBox[ 6 ].Left, CheckBox[ 6 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    if AI.HoldandRun then
      WrapperBltFast( lpDDSBack, CheckBox[ 7 ].Left, CheckBox[ 7 ].Top, Check, Rect( 0, 0, CheckW, CheckH ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
  end;
end;
